          ...
          >
            {type === "TS" ? (
              <>
                ...
                <Text className="text-gray-700 text-base leading-loose mb-4">
                  You must be at least 13 years old to use Nurtura. You agree to
                  use the app only for lawful purposes. We reserve the right to
                ...
                <Text className="text-gray-700 text-base leading-loose mb-4">
                  ...
                  activity under your account. Provide accurate information and
              ...
              <>
                ...
                <Text className="text-gray-700 text-base leading-loose mb-4">
                  ...
                  data to provide a better experience and improve our services.
                </Text>
